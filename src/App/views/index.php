...
<section data-barba="container" data-barba-namespace="home" class="container mx-auto mt-12 p-4 bg-white shadow-md border border-gray-200 rounded">
            ...
            <?php foreach ($transactions as $transaction): ?>
                <tr>
                    ...
                    <td class="p-4 text-sm text-gray-600">
                        <?php if (isset($transaction['receipt_id'])): ?>
                            <div class="inline-block relative cursor-pointer">
                                <a href="/transaction/<?php echo $transaction['id']; ?>/receipt/<?php echo $transaction['receipt_id']; ?>">
                                ...
                                <form action="/transaction/<?php echo $transaction['id']; ?>/receipt/<?php echo $transaction['receipt_id']; ?>" method="POST">
    ...
    <nav class="flex items-center justify-between border-t border-gray-200 px-4 sm:px-0 mt-6">
        ...
        <div class="hidden md:-mt-px md:flex">
            <?php foreach ($pageLinks as $pageNum => $pageQuery): ?>
                <a href="/?<?php echo $pageQuery; ?>" class="<?php echo $pageNum + 1 === $currentPage ? "border-indigo-500 text-indigo-600" : "border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300"; ?> inline-flex items-center border-t-2 px-4 pt-4 text-sm font-medium">
                    <?php echo $pageNum + 1; ?>
                </a>
            <?php endforeach; ?>
