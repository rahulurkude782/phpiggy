    ...
    <form method="POST" class="grid grid-cols-1 gap-6">
        ...
        <label class="block">
            ...
            <?php if (array_key_exists('email', $errors)): ?>
                <div class="bg-gray-100 mt-2 p-2 text-red-500 rounded">
        ...
        <label class="block">
            ...
            <?php if (array_key_exists('social_media_url', $errors)): ?>
                <div class="bg-gray-100 mt-2 p-2 text-red-500 rounded">
                    <p><?php echo $errors['social_media_url'][0]; ?></p>
                </div>
            <?php endif; ?>
        </label>
        <!-- Password -->
        ...
        <label class="block">
            ...
            <?php if (array_key_exists('confirm_password', $errors)): ?>
                <div class="bg-gray-100 mt-2 p-2 text-red-500 rounded">
                    <p><?php echo $errors['confirm_password'][0]; ?></p>
                </div>
            <?php endif; ?>
        </label>
        <!-- Terms of Service -->
